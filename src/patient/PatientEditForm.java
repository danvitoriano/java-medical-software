 ...
 * @author vitoriano
 */
public class PatientEditForm extends javax.swing.JFrame {

    Patient userEdit;

    public PatientEditForm(Patient user) {
        initComponents();
        this.userEdit = user;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientEditForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientEditForm().setVisible(true);
            }
        });
    }
