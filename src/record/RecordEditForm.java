 ...
 * @author vitoriano
 */
public class RecordEditForm extends javax.swing.JFrame {

    Record userEdit;

    public RecordEditForm(Record user) {
        initComponents();
        this.userEdit = user;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecordEditForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecordEditForm().setVisible(true);
            }
        });
    }
