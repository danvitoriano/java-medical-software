...
public class RecordListForm extends javax.swing.JFrame {
     ...
     * @param patient pass Patient to be recorded
     */
    ...
    private void jButtonNovoUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoUsuarioActionPerformed
        ...
        RecordAddForm form = new RecordAddForm();
        form.show();
    ...
    /**
     * 
     * @param patient initialize patient
     */
    public static void main(Patient patient) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecordListForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
