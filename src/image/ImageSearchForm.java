 ...
 * @author vitoriano
 */
public class ImageSearchForm extends javax.swing.JFrame {
...
//            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImageSearchForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ImageSearchForm().setVisible(true);
            }
        });
    }
